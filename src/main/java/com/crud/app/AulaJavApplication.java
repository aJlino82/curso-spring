...
import com.crud.app.domain.Pagamento;
import com.crud.app.domain.PagamentoComBoleto;
import com.crud.app.domain.PagamentoComCartao;
...
import com.crud.app.repositories.PagamentoRepository;
...
public class AulaJavApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Pedido ped1 = new Pedido(null, sdf.parse("30/09/2022"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2022"), cli1, e2);
